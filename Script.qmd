...
```{r}
ggplot(data, aes(x=total_price)) + geom_histogram(binwidth=1) +
  labs(
    title = "Histogram cen",
    x = "Cena",
    y = "Ilość"
...
ggplot(data, aes(x=loyalty_points_earned)) + geom_histogram(binwidth=1) +
  labs(
...
ggplot(data, aes(x=payment_method)) + geom_bar() +
  labs(
